...
- 类 MQ 转发底座 runtime（真实 JDBC adapter / Flyway migration / broker / queue / DLQ / replay 存储；C3 schema 草案已就绪 Stage 8，物理实现 deferred Stage 9+）。
