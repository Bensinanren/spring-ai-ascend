...
| FEAT-005 | 智能体中间件请求代理 | runtime 读取 Agent 的 skill 来源配置，并将本地 skill 路径和 GitHub 远端 skill 路径纳入 Agent 运行环境。 | [FEAT-005-runtime-agent-skill-config.md](./FEAT-005-runtime-agent-skill-config.md) | 待补充 |
