...
| FEAT-005 | 智能体中间件请求代理 | runtime 在部署态读取 Agent 配置，并通过 SkillHub Provider 按稳定部署上下文获取、加载和安装相应 skill，使 skill 来源与具体 Agent 框架解耦。 | [FEAT-005-agent-middleware-request-proxy.md](./FEAT-005-agent-middleware-request-proxy.md) | 待补充 |
