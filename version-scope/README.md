...
| FEAT-005 | 智能体中间件请求代理 | runtime 通过 Skill Hub SPI 管理连接认证与访问控制、安全访问、skill 下载和 Agent 注入，首版本默认对接 openJiuwen Skill Hub 服务 API。 | [FEAT-005-runtime-agent-skill-config.md](./FEAT-005-runtime-agent-skill-config.md) | 待补充 |
