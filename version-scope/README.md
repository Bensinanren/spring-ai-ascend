...
| FEAT-005 | 智能体中间件请求代理 | 系统在部署态读取 Agent 配置，并根据配置从 Skill Hub 获取相应 skill，使 Agent 能力可由部署配置驱动。 | [FEAT-005-agent-config-skillhub-skills.md](./FEAT-005-agent-config-skillhub-skills.md) | 待补充 |
