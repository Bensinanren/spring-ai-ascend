...
**65 §4 constraints · 139 ADRs · 94 active gate rules · 194 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 132 enforcer
rows, and a 603-node / 1185-edge architecture graph — all maintained in
