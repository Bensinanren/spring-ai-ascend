...
**65 §4 constraints · 139 ADRs · 149 active gate rules · 282 gate self-tests**,
plus 13 Layer-0 governing principles, 55 active engineering rules, 185 enforcer
rows, and a 668-node / 1291-edge architecture graph — all maintained in
