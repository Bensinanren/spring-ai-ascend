...
import com.huawei.ascend.bus.registry.runtime.api.MvpRegistryController;
import com.huawei.ascend.bus.registry.runtime.discovery.PgMvpDiscoveryServiceImpl;
import com.huawei.ascend.bus.registry.runtime.health.MvpHealthProbeScheduler;
...
import com.huawei.ascend.bus.spi.registry.RouteResolution;
...
class AgentRegistryEndToEndIntegrationTest {
    ...
    static void bootStack() throws Exception {
        ...
        discovery = new PgMvpDiscoveryServiceImpl(
                repository,
                new com.huawei.ascend.bus.registry.runtime.tenant.ThreadLocalTenantContext(),
                observability);
