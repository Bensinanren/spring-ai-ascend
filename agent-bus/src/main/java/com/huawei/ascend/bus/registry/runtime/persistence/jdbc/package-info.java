 ...
 * {@code com.huawei.ascend.bus.registry.**} allowed to import {@code java.sql}
 * / {@code javax.sql} / {@code org.springframework.jdbc.*} /
 * {@code javax.sql.DataSource}. The {@code api} / {@code discovery} /
 * {@code health} subpackages call {@link com.huawei.ascend.bus.registry.runtime.persistence.jdbc.AgentRegistryRepository}
 * and never touch JDBC directly — enforced at test time by
 * {@code AgentBusRegistryJdbcPurityTest} (S5) and at edit time by the
 ...
 * 下沉 to {@link com.huawei.ascend.bus.registry.runtime.persistence.jdbc.JdbcAgentRegistryRepository},
 ...
 * Every method on {@link com.huawei.ascend.bus.registry.runtime.persistence.jdbc.JdbcAgentRegistryRepository}
 ...
 * connection is filtered by tenant. This mirrors the
 * {@code JdbcForwardingOutbox} Stage 24 wiring pattern. Application-layer
 ...
 * {@code AgentBusRegistryJdbcPurityTest} Consul-forbidden assertion.
 */
