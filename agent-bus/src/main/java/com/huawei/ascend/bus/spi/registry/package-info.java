 ...
 * {@link com.huawei.ascend.bus.spi.registry.AgentDiscoveryService} contract,
 * the unified {@link com.huawei.ascend.bus.spi.registry.AgentCardDto} with
 * {@code @Nullable} business definition fields, the
 * {@link com.huawei.ascend.bus.spi.registry.RouteResolution} returned by
 * {@code resolveRouteHandle}, and the
 * {@link com.huawei.ascend.bus.spi.registry.TenantContext} port all live here so
 ...
 * {@code AgentBusRegistrySpiPurityTest}. The MVP implementation
 * ({@code PgMvpDiscoveryServiceImpl}) lives in
 * {@code com.huawei.ascend.bus.registry.runtime.discovery} and is selected
 * via {@code @Primary}; the phase-2 Consul implementation swaps in without
 * touching this package.
 *
 * <p>{@link com.huawei.ascend.bus.spi.registry.Nullable} is a local marker
