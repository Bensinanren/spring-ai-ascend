 ...
 * decision 4). The only class in {@code com.huawei.ascend.bus.registry.**}
 * allowed to import {@code java.sql} / {@code javax.sql} /
 * {@code org.springframework.jdbc.*} — enforced at test time by
 * {@code AgentBusRegistryJdbcPurityTest} (S5).
 *
 * <h2>SQL contract</h2>
 * <ul>
 ...
 * </ul>
 *
 * <h2>Stage 24 RLS wiring (mirrors {@code JdbcForwardingOutbox})</h2>
...
public final class JdbcAgentRegistryRepository implements AgentRegistryRepository {
    ...
    /**
     * Stage 24 RLS wiring — see class javadoc. Identical pattern to
     * {@code JdbcForwardingOutbox#withTenant}.
     */
