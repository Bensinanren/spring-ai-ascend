 ...
 *
 * <p>Component scan covers {@code com.huawei.ascend.bus..} so
 * {@link com.huawei.ascend.bus.registry.runtime.RegistrySchedulingConfig}
 * (which anchors {@code @EnableScheduling} for the probe scheduler) and
 * {@link com.huawei.ascend.bus.registry.runtime.RegistryObservabilityConfig}
...
public class AgentBusApplication {

    public static void main(String[] args) {
        SpringApplication.run(AgentBusApplication.class, args);
    }
}
