...
import com.huawei.ascend.service.sessionmanage.memory.SessionNotFoundException;
...
public final class RedisSessionStateAdapter implements SessionStatePort {

    private final RedisSessionCommands commands;
    private final SessionCodec codec;
    private final RedisSessionStateProperties properties;

    public RedisSessionStateAdapter(
